...
def format_alert_message(alert: dict) -> str:
    ...
    signal_tf_bias = str(context.get("signal_tf_bias") or alert.get("signal_tf_bias") or payload.get("signal_tf_bias") or "-")
    ...
    parts.append(f"Signal TF bias: {signal_tf_bias}")
    parts.append(
        "Checks: "
